    ...
    <>
      ...
      <div className="page-wrap">
        ...
        <div className="page-hero" style={{ background: '#f8f9fa' }}>
          ...
          <p style={{ fontSize: '2.4rem', color: '#444444', fontWeight: 600 }}>과학의 본질을 이해하는 수업</p><div className="sec-label" style={{ color: '#9E9E9E' }}>Understanding the Essence of Science</div>
        </div>
        ...
        <section className="section" style={{
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
           <p className="sec-desc" style={{ margin: '0 auto 2rem', fontSize: '1.4rem', lineHeight: 2 }}>
              ...
              <span style={{ whiteSpace: 'nowrap' }}>강의하는 아이들은 과학을 '외우는 과목'이 아닌 '이해하는 과목'으로 바꾸는 공간입니다.</span><br /><br /><br />
