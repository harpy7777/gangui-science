...
const teachers = [
  ...
  { photo: '/teacher2.jpg', name: '김인후 선생님', subject: '통합과학, 화학 전문', career: ['19년 이상의 입시 경험', '목동 주요 중·고교 내신 및 수능 분석 전문가', '최상위권 결과로 실력을 증명해온 과학 전문 강사'] },
    ...
    <>
      ...
      <div className="page-wrap">
        ...
        <section className="section">
          <div style={{ maxWidth: '620px', margin: '0 auto', padding: '3rem 0', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {teachers.map(t => (
